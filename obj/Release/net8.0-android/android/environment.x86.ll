...
@dso_cache = dso_local local_unnamed_addr global [630 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1494068955, ; hash 0x590daedb, from name: aot-LJ.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2261825664, ; hash 0x86d0b880, from name: LJ
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LJ.dll.so
		ptr null; void* handle (0x0)
	}, ; 338
	...
	%struct.DSOCacheEntry {
		i64 3307042380, ; hash 0xc51d764c, from name: libaot-LJ
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LJ.dll.so
		ptr null; void* handle (0x0)
	}, ; 499
	...
	%struct.DSOCacheEntry {
		i64 3552750442, ; hash 0xd3c2ab6a, from name: aot-LJ
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LJ.dll.so
		ptr null; void* handle (0x0)
	}, ; 524
	...
	%struct.DSOCacheEntry {
		i64 3953616479, ; hash 0xeba7665f, from name: libaot-LJ.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LJ.dll.so
		ptr null; void* handle (0x0)
	}, ; 579
	...
	%struct.DSOCacheEntry {
		i64 4007038382, ; hash 0xeed68dae, from name: LJ.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LJ.dll.so
		ptr null; void* handle (0x0)
	}, ; 587
